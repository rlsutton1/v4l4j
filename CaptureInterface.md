...
If this method is successful (returned value of 0), resources MUST be released when finished as explained in the [Free resources](#Free_resources.md) section, even if some or all of the next steps fail.
